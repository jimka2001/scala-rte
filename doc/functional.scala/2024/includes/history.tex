...
\begin{frame}{Publication History}
  \begin{itemize}
  \item Regular Type Expressions (RTEs) introduced at 2016 European Lisp Conference, implemented in Common Lisp.
...
\begin{frame}{Goal}
  \begin{itemize}
  \item Efficiently recognize patterns in heterogeneously typed sequences.

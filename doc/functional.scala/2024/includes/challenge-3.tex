...
\begin{frame}{\Challenge{3} Type Lattice}
  ...
  \begin{itemize}
  \item   Support \Emph{complement type lattice}
...
\begin{frame}{Simple Embedded Type System: SETS}
  ...
  For more info, see: \textit{A Portable, Simple, Embeddable Type System} [Newton, Pommellet] 2021 European Lisp Symposium

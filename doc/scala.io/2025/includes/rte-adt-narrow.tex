  ...
  \node [bottom color=orange!20] {Rte}
    child { node [bottom color=orange!20] {RteNode}
      child { node [bottom color=orange!20] {Combination} 
        ...
        child { node {Or} } }
      child { node {Star} }
      child { node [right=-11mm] {Not} }
      child { node [right=-18mm] {Cat} } }
child { child {
    child { node [bottom color=orange!20, left=10mm] {RteTerminal}
      child { node [text height=20pt, right=-10mm, top color=white, bottom color=red!20] {Singleton\\SimpleTypeD} }
      child { node [right=0] {Sigma} }
      child { node [right=-2mm] {EmptySet} }
      child { node [right=1mm] {EmptySeq} } } } };
\end{tikzpicture}
\end{document}

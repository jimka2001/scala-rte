...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \only<1>{\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-retention-Aspect-Ratio}}%
      \only<2>{\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-retention-Aspect-Ratio-ratsnest}}
    \end{column}
    \begin{column}{.33\textwidth}
      \textcolor{orange}{Restricted to RTEs having exactly 128 leaf nodes.}

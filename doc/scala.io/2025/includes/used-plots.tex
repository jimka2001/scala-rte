...
\begin{frame}
  \begin{columns}
    \begin{column}{.85\textwidth}
      \includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-64-histogram}      
    \end{column}\hspace{-1cm}
    \begin{column}{.33\textwidth}
      ...
      Balanced sampling results $\approx 22$ to 23\% of DFAs with 10 states or larger.
      Uniform sampling results in range $20 \%$ to 23.
    \end{column}
  \end{columns}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.85\textwidth}
      \includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-128-histogram}      
    \end{column}\hspace{-1cm}
    \begin{column}{.33\textwidth}
      ...
      Balanced sampling results $\approx 20\%$ to 32 of DFAs with 10 states or larger.
...
\begin{frame}
  \begin{columns}
    \begin{column}{.85\textwidth}
      ...
      \only<3>{\includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-64-dfa-state-count-vs-Aspect-Ratio-ratsnest}}%
      \only<4>{\includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-128-dfa-state-count-vs-Aspect-Ratio-ratsnest}}
    \end{column}\hspace{-1cm}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.85\textwidth}
\includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-64-threshold}
    \end{column}\hspace{-1cm}
    \begin{column}{.33\textwidth}
      \textcolor{orange}{Restricted to RTEs with exactly 64 leaf nodes.}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.85\textwidth}
\includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-128-threshold}
    \end{column}\hspace{-1cm}
    \begin{column}{.33\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.85\textwidth}
      \only<1>{\includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-128-retention-Aspect-Ratio}}%
      \only<2>{\includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{plot-128-retention-Aspect-Ratio-ratsnest}}
    \end{column}\hspace{-1cm}
    \begin{column}{.33\textwidth}

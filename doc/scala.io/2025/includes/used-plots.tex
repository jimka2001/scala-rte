...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-histogram}      
    \end{column}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-64-histogram}      
    \end{column}
    \begin{column}{.33\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-histogram}      
    \end{column}
    \begin{column}{.33\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-dfa-state-count-vs-Aspect-Ratio}
    \end{column}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-dfa-state-count-vs-Aspect-Ratio-ratsnest}
    \end{column}
    \begin{column}{.35\textwidth}
      DFA state count \\vs Aspect Ratio
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-64-dfa-state-count-vs-Aspect-Ratio-ratsnest}
    \end{column}
    \begin{column}{.35\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-dfa-state-count-vs-Aspect-Ratio-ratsnest}
    \end{column}
    \begin{column}{.35\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-threshold}
    \end{column}
    \begin{column}{.35\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-64-threshold}
    \end{column}
    \begin{column}{.33\textwidth}
      \textcolor{orange}{Restricted to RTEs with exactly 64 leaf nodes.}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-threshold}
    \end{column}
    \begin{column}{.33\textwidth}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \only<1>{\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-retention-Imbalance-Factor}}%
      \only<2>{\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-retention-Imbalance-Factor-ratsnest}}
    \end{column}
    \begin{column}{.33\textwidth}
      \textcolor{orange}{Restricted to RTEs having exactly 128 leaf nodes.}

...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-lossage-Imbalance-Factor-ratsnest.png}
    \end{column}
    \begin{column}{.35\textwidth}

      Lossage = $\lambda = \frac{state~count}{node~count}$
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-64-lossage-Imbalance-Factor-ratsnest.png}
    \end{column}
    \begin{column}{.35\textwidth}
      \textcolor{orange}{Restricted to RTEs having exactly 64 leaf nodes.}
...
\begin{frame}
  \begin{columns}
    \begin{column}{.8\textwidth}
      \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{plot-128-lossage-Imbalance-Factor-ratsnest.png}
    \end{column}
    \begin{column}{.35\textwidth}
      \textcolor{orange}{Restricted to RTEs having exactly 128 leaf nodes.}
